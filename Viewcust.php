...
<div id="ACSI_body_wrapper">
  <div id="ACSI_wrapper">
    ...
    <div id="ACSI_menubar">
      ...
      <li><a href="Viewcust.php">customer detail </a></li>
    </div>
			<div id="ACSI_search">
      ...
      <div id="sidebar" class="float_r">
        ...
        <div class="sidebar_box"><span class="bottom"></span>
          ...
          <div class="content">
            ...
            <?php
						$sel=mysql_query("select * from service where id = '1' AND status = 'on'");
							...
							$num=1;
							echo '<font color=white> '.$num. '</font>&raquo;  ' .$gets['serv'].' '.$gets['desc'].'<br/>';
							$num=2;
	     ...
	     <div id="content" class="float_l"> <br/>
						 ...
						 <li><a href="Officer.php"></a></li>
       
	   
	   
	    <style type="text/css">
			th{border-bottom:1.5px solid #333333;border-left:1.5px solid #333333;border-right:2px solid #333333;border-top:1.5px solid #666666; padding-bottom:1.5px;}
			td{ border-bottom:1.5px solid #3F3F3F ;border-left:1.5px solid #333333;border-right:1.5px solid #333333}
			th {font-size:75%;background-color:#003300;}
			td {font-size:70%;}
</style>
...
// Select Database
mysql_select_db("acsik", $con);
// Specify the query to execute

//$txtAccount_no=$_POST['txtAccount_no'];
$sql = "select * from customer order by user_id DESC ";
// Execute query
...
{
$user_id=$row['user_id'];
$Name=$row['fame']." ".$row['lname'];

$profile_pic =$row['profile_pic'];
?>
                  
                   <tr>
  <td class="style6"><div align="left" class="style9 style5 style4 style3">
            <strong><?php echo $Account_no;?></strong></div></td>
  <td class="style6"><div align="left" class="style9 style5 style4 style3">
             <strong><?php echo $Name;?></strong></div></td>
  
  <td class="style6"><div align="left" class="style9 style5 style4 style3">
        <strong><img src="../Documents/<?php echo $Photo;?>" height="100" width="100" />
            </strong></div></td>

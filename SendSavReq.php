...
?>		 
      ...
      <div class="product_box">
       <div align='center' style="border-radius: 5px;border:1px double #b9b9b9;width:680"><br/>
		<form method="post" action="SendSavReqDB.php" name="myform" >
          ...
          <table  border="0" cellspacing="3" cellpadding="5"  id='mytable' summary="sending request">
			...
			SAVING REQUEST FORM</font></th></tr>
...
<td>
<input name="acc" type="text" required id='in' value="<?php echo $fetch[5] ?>" onKeyUp="AllowAlphabet()"/>
</td>
</tr>
...
<td>
<input name="am" type="text" required  id="name" onKeyUp="AllowAlphabet()"/ >

...
?>
	...
	function AllowAlphabet(){
		...
		<h4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         <font color='#ffff00'face = 'Georgia'><b><br/>POST NEWS FOR CUSTOMERS</b></font></h4>
		  	  <form method="post" action="newscust.php" name="myform"><br/>
...
VALUES
('$_POST[tittle]','$_POST[date]','$_POST[comment]','2')";
...
echo '<img src="images/492.png" > &nbsp;! News has been Post Successfully!';
			...
			echo' <meta content="2;newscust.php" http-equiv="refresh" />';
}
//mysql_close($conn)
?>

  ...
  <div id="ACSI_wrapper">
            ...
            <li><a href="PayWithdrawal1.php ">Pay Withdrawal </a></li>
              <li><a href="PayCredit1.php">Pay  Credit </a></li>
			    <li><a href="CollectCredit1.php ">Collect Credit </a></li>
				   ...
				   <li><a href="PaySaving1.php">inital Saving </a></li>
            </ul>
    </div>
		<div id="ACSI_search">
    ...
    <div id="ACSI_main">
      <div id="sidebar" class="float_r">
        ...
        <a href=CollectCredit.php ><img src="images/up.png" width="22" height="25" title=Back align='top'/></a><br/><br>
...
$sel=mysql_query("SELECT * FROM credit WHERE AccNumber=$id");
...
?>		
		...
		<h4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         <font color='#ffff00'face = 'Georgia'><b><br/>UPDATE CREDIT BALANCE </b></font></h4>
		  <form action="PayInsertCrdDB.php" method="POST" name="myform"><br/>
       
          <table  border="0" cellspacing="3" cellpadding="5"  id='mytable'summary="registering account">
    <tr>
              <td  height="24">First Name</td>
             
              <td ><input type="text" name="fname" size="30" value="<?php echo $fetch[1] ?>" ></td>
            </tr>
			<tr>
              <td>Last Name</td>
             
              <td><input type="text" name="lname" size="30" value="<?php echo $fetch[2] ?>" ></td>
			 </tr>           
<tr>
<td>
<b>Account Number</b>
...
<td>
<input name="acc" type="text" required value="<?php echo $fetch[3] ?>"  />
</td>
</tr>
...
<td><input name="dur" type="text" required/ value="<?php echo $fetch[4] ?>"></td>
</tr>
 <tr>
<td>
<b>Amount You Return</b>
</td>
<td>
<input name="return" type="text"required/ >
</td>
</tr>	
<tr>
<td>
...
<td>
<input name="date" type="text"required value="<?php echo $fetch[8] ?>" />
</td>
</tr>
...
<td>
<input name="due" type="text"required/ value="<?php echo $fetch[9] ?>" />
</td>
</tr>		

...
<div style="float:right; margin-right:24px;" ;>
  ...
  |<a href="logoutam.php" class="logout"><font color="white"> ውጣ</a>&nbsp;|
  <a href="manageAccCust.php" class="logout" ><font color="white"> አካውንት አስተካክል</a></div>
 <?php
include("headerAm.php");
?>
 <!-- END of ACSI_Header -->
<?php
include("TopNavCustAm.php");
?>
    <!-- END of ACSI_menubar -->

...
$ctrl = $row['AccNumber'];
 ...
 <a href = 'PayInsertSav.php?key=".$ctrl."'>
 <img src = 'images/edit-icon.png' border = '0' title='Insert_information' width=25 height=25;'></img></a>
		</td>");
		print("<td align = 'center' width = '1'>
 <a href = 'PayviewSav.php?key=".$ctrl."'>
 <img src = 'images/view.png' border = '0' title='view_information' width=25 height=25 ;'></img></a>
		</td>");
		print("<td align = 'center' width = '1'>
 <a href = 'CGSV.php?key=".$ctrl."'>

...
$sel1 = mysql_query("SELECT * FROM customer  WHERE month(date) = '$month' AND year(date) = '$yr'  AND AccType='credit'; ;");
	...
	<table border="1"cellpadding="0"  cellspacing="0" style="width:70%">
            ...
            <tr>
              <td width="15%"  height="43" align=center>ወርሀዊ ኮፒ</td>
              <td >&nbsp;</td>
            ...
            <tr>
              <td colspan="3"><i>
                <hr>
				<p style="padding-left:10em;">	የደንበኞች ብዛት =>
				<?php echo $num;?></p>
			   <hr/>
                </i></td>
            </tr>
              ...
              <td colspan="3"><i>
                <hr>
				<p style="padding-left:10em;">	 የቁጠባ ሒሳብ ያላቸው ደንበኞች ብዛት    =>
				<?php echo $u5;?></p>
			   <hr/>
                </i></td>
            </tr>
		 ...
		 <tr>
              <td colspan="3"><i>
                <hr>
				<p style="padding-left:10em;">	 የብድር ሒሳብ ያላቸው ደንበኞች ብዛት   =>
				<?php echo $u5;?></p>
			   <hr/>
                </i></td>
            </tr>

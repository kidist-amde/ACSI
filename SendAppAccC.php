...
<a href=ApproveCredit.php ><img src="images/up.png" width="22" height="25" title=Back align='top'/></a><br/>

	   <div class="product_box">
        
		<h3><center><font color='#ffff00' face = 'Georgia'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			SEND APPOINTMENT TO THE CUSTOMER</h3></center></font>
<form method="post" action="SendAppAccDBC.php" >
   ...
   <tr>
	 ...
	 <td><input name="date" size="32" type="text" value=<?php echo date('y-m-d')?> readonly="true"></td>
     </tr>
     <tr>

    ...
    <!-- END of ACSI_menubar -->
	  ...
	  ?>
	     <div id="content" class="float_l"> <br/>
	  		 ...
	  		 <a href=manageAccCSP.php ><img src="images/up.png" width="22" height="25" title=Back align='top'/></a><br/>

		<br/><br/><div align='center' style="border-radius: 5px;
				border:1px double #b9b9b9;width:680"><br/>
			<form action="changepassCSP.php" method="post" name="myform">
...
$cpass =clean(base64_encode($_POST['curpass']));
				...
				echo '<meta content="2;manageAccCSP.php" http-equiv="refresh" />';

					}
				else{
				echo '<img src="images/no.ico" /> &nbsp;! New password and Repeat password is not much';
				echo '<meta content="2;changepassCSP.php" http-equiv="refresh" />';
					}

	  ...
	  ?>
	     <div id="content" class="float_l"> <br/>
		  ...
		  <br/><br/><div align='center' style="border-radius: 5px;border:1px double #b9b9b9;width:680"><br/>
			<h5><font color='#ffff00' style="text-transform:uppercase;font-weight:" face='georgia'>
			What do you want to do for your account?</font></h5>

				&nbsp;<a href="changepassCust.php"><b>Change Password</b></a><br/>&nbsp;&nbsp;&nbsp;
				
				<a href="changeunCust.php"><b>Change User Name</b></a><br/><br/>
				</div>

...
?>
    <!-- END of ACSI_menubar -->
	  ...
	  ?>
		...
		<h4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         <font color='#ffff00'face = 'Georgia'><b><br/>POST ADVERTISMENT </b></font></h4>
		  	  
       <form method="post" action="postAdvrt.php" name="myform"><br/>
          <table  border="0" cellspacing="3" cellpadding="5"  id='mytable'summary="registering account">

	 <tr>
     <td ><b><font size="2px" face = 'Georgia'>Date</font></b></td><td>
	 <input name="date"  size="32" id="name" type="text" value="<?php echo date('y-m-d')?>" readonly="true"></td>
     </tr>
      <tr>
     <td><center><font size="2px" face = 'Georgia'>Write Descrption here</font></center></td>
	 ...
	 <input name="status" value="1" size="32" id="name" type="text"></td>
     </tr>
...
$sql="INSERT INTO about( date,description,status)
VALUES
('$_POST[date]','$_POST[comment]','$_POST[status]')";
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Advrtisment has been post Successfully !!</font></p>";
echo' <meta content="2;postAdvrt.php" http-equiv="refresh" />';
}
//mysql_close($conn)
?>

...
$ctrl = $row['AccNumber'];
 ...
 <a href = 'PayCreditI.php?key=".$ctrl."'>
 <img src = 'images/46.png' border = '0' width='25' height='25' title='Pay_Credit' onclick='isupdate();'></img></a>
		</td>");
		print("<td align = 'center' width = '1'>
 <a href = 'PayviewCrd.php?key=".$ctrl."'>
 <img src = 'images/view.png' border = '0' title='view_information' width=25 height=25 ;'></img></a>
		</td>");
 
		 print("<td align = 'center' width = '1'>
 <a href = 'CGC.php?key=".$ctrl."'>
